...
public final class CurseForgeAPIRoutes
{
    ...
    public static final String MODPACKS_SEARCH = API_BASE_URL + "/v1/mods/search?gameId=432&classId=4471&categoryId={categoryId}&gameVersion={version}&index={index}&pageSize={size}&searchFilter={modpackName}&sortField=2&sortOrder=desc";
    ...
    public static final String MODPACK_LATEST_SERVER_DOWNLOAD_URL = API_BASE_URL + "/v1/mods/{modpackId}/files/{fileId}/download-url";
