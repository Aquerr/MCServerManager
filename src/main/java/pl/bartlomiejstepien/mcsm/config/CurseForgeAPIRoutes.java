...
public final class CurseForgeAPIRoutes
{
    ...
    public static final String MODPACKS_SEARCH = "https://addons-ecs.forgesvc.net/api/v2/addon/search?categoryId={categoryId}&gameId=432&gameVersion=&index=0&pageSize={size}&searchFilter=&sectionId=4471&sort=0";
